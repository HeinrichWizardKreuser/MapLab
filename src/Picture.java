...
public final class Picture implements ActionListener {
    ...
    public BufferedImage bufferedImage() { return image; }// personal add in
...
//PERSONAL ADD IN
//opens the dialog to choose where to save the image. Note: Automatically saves as .png
    public void saveDialog() {
        FileDialog chooser = new FileDialog(frame, "Choose file destination", FileDialog.SAVE);
        chooser.setVisible(true);
        if (chooser.getFile() != null) {
            String s = chooser.getDirectory() + File.separator + chooser.getFile();
            if (s.endsWith(".png")) save(s);
            else save(s+".png");
        }
    }
